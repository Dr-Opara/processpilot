...
| `external_access_grants`        | `20260805000001_external_portal`                           |      Nullable       | Phase 19. See [external-portal.md](external-portal.md). Ties one invitation to one task; partial unique index on `task_id` enforces one live grant per task.                                                                                           |
